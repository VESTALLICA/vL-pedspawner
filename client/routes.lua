...
-- edit these templates to your liking
...
DeletePatrolRoute('miss_TemplatePed') -- must clear the previously created patrol route to create and open a new one. this will not literally delete it and the previous ped will still follow the previous route.
